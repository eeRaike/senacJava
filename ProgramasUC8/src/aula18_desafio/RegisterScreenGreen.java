 ...
 * @author Aluno
 */
public class RegisterScreenGreen extends javax.swing.JFrame {

    /**
     * Creates new form registerScreen
     */
    public RegisterScreenGreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnCancel.setBackground(new java.awt.Color(0, 102, 51));
        btnCancel.setForeground(new java.awt.Color(0, 102, 51));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/aula18_desafio/imgs/arvore.png"))); // NOI18N
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        try {
            LoginScreenGreen loginScreen = new LoginScreenGreen();
            loginScreen.setVisible(true);
            this.dispose();
        } catch (FileNotFoundException ex) {
            Logger.getLogger(RegisterScreenGreen.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        }else if(name.isBlank() || username.isBlank() ||password.isBlank() || confPassword.isBlank()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterScreenGreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterScreenGreen().setVisible(true);
            }
        });
    }
